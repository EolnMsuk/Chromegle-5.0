...
class SettingsMenu {
    ...
    static #isInitialized = false; // <<< NEW: Add this static flag

    constructor() {
        // <<< NEW: Add this check at the very top of the constructor
        if (SettingsMenu.#isInitialized) {
            Logger.WARN("SettingsMenu constructor called twice. Aborting duplicate.");
            return;
        }
        SettingsMenu.#isInitialized = true; // <<< NEW: Set the flag
        // --- END OF FIX ---
